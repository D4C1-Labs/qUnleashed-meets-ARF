...
// [ARF] Parser for the Flipper-ARF firmware (D4C1-Labs fork).
// The directory.json is generated by the ARF build workflow (in the
// Flipper-ARF repo) and published to the GitHub Pages of the website repo
// (D4C1-Labs/Flipper-ARF-Website), which serves it as a static asset. It
// follows the exact same schema as Unleashed/Official
// (channels[].versions[].files[]). ARF has no compact/extra-packs variants,
// so the standard flow (version.updatePackageFor('f7')) in source.dart is
// sufficient — no variant URL rewriting is needed here.
class ArfParser extends FirmwareParser {
  ArfParser._();
  static final ArfParser instance = ArfParser._();

  @override
  String get directoryUrl =>
      'https://d4c1-labs.github.io/Flipper-ARF-github-page/directory.json';
}
