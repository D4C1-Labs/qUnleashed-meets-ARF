...
// Reference Fiat V1 authenticator, defined in fiat_v1_ref.c. Declared here
// locally so this host build does not depend on the firmware's
// lib/subghz/protocols/fiat_v1.h (which pulls in FlipperFormat/subghz).
